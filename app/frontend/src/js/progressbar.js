...
handleButtonClick(
  purchasedBtn,
  'progressbar-purchased',
  'progress-text-purchased',
  'purchased-files',
  'progress-container-purchased'
)
handleButtonClick(
  paidItemsBtn,
  'progressbar-paid',
  'progress-text-paid',
  'paid-files',
  'progress-container-paid'
)
handleButtonClick(
  inPlaceBtn,
  'progressbar-inPlace',
  'progress-text-inPlace',
  'inPlace-files',
  'progress-container-inPlace'
)
handleButtonClick(
  conditionsBtn,
  'progressbar-conditions',
  'progress-text-conditions',
  'conditions-files',
  'progress-container-conditions'
)
...
if (claimBtn) {
  handleButtonClick(
    claimBtn,
    'progressbar-claim',
    'progressbar-text-claim',
    'claim-files',
    'progress-container-claim'
  )
}
